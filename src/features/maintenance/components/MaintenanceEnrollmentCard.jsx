 ...
 */
export function MaintenanceEnrollmentCard({
  customerName,
  line,
  statusLabel,
  statusRaw = '',
  ...
  const pillTheme = useMemo(
    () => getMaintenanceStatusPillTheme(statusRaw, colors, isDark),
  ...
  if (onPress) {
    return (
      <Pressable
        accessibilityHint="Opens maintenance detail"
        accessibilityLabel={`Maintenance for ${customerName}`}
